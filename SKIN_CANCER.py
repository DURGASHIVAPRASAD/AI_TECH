...
training_set = train_datagen.flow_from_directory('skin_cancer//Train_data',target_size = (64, 64),
                                                 batch_size = 32,class_mode = 'binary')#class_mode=categorical to work on multiple

test_set = test_datagen.flow_from_directory('skin_cancer//Test_data',target_size = (64, 64),
...
test_image = image.load_img('D:/skin_cancer/Train_data/Benign/ISIC_0000014.jpg', target_size = (64, 64))
# This is test img
...
#import numpy as np
#from keras.preprocessing import image
test_image = image.load_img('D:/skin_cancer/Test_data/Benign/ISIC_0000527.jpg', target_size = (64, 64))
test_image = image.img_to_array(test_image)
test_image = np.expand_dims(test_image, axis = 0)
result = classifier.predict(test_image)
